...
TEST_CASE("Codex Object")
{
  ...
  SECTION("Create/Destroy")
  {
    ...
    CODEX_BOOL should_exist = codex_object_exists(ctx, obj_id);
    REQUIRE(should_exist == CODEX_TRUE);

    CODEX_BOOL destroy_obj = codex_object_destroy(ctx, obj_id);
    REQUIRE(destroy_obj == CODEX_TRUE);

    CODEX_BOOL should_not_exist = codex_object_exists(ctx, obj_id);
