...
roa_float3    roa_float3_init_with_value(float v);
roa_float3    roa_float3_init_with_values(float x, float y, float z);
...
roa_float3    roa_float3_dot(roa_float3 a, roa_float3 b);
...
void          roa_mat4_projection(roa_mat4 *out, float fov, float near, float far, float width, float height);
